...
#Correlation and Covariance Analysis ----
  ...
  ##The Pearson Correlation index between the numerical variables ----
mycor <- cor(numdf);mycor

  ##Graphical Representation ----
chart.Correlation(numdf, histogram = F, pch = 19)
pairs.panels(numdf)
corrplot(mycor, type = "upper", method= "number")
